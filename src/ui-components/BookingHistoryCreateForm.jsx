...
import { createBookingHistory } from "../graphql/mutations";
const client = generateClient();
export default function BookingHistoryCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAdult(initialValues.adult);
    setChild(initialValues.child);
    setInDate(initialValues.inDate);
    setOutDate(initialValues.outDate);
    setRateCode(initialValues.rateCode);
    setRoomCode(initialValues.roomCode);
    setRoomRate(initialValues.roomRate);
    setCardNumber(initialValues.cardNumber);
    setCardExpDate(initialValues.cardExpDate);
    setCardCVVNo(initialValues.cardCVVNo);
    ...
    setConfirmationNumber(initialValues.confirmationNumber);
    setStatus(initialValues.status);
    setZipCode(initialValues.zipCode);
    setReceipt(initialValues.receipt);
    setIsChangeDisabled(initialValues.isChangeDisabled);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBookingHistory.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BookingHistoryCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"

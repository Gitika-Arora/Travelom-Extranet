...
export declare type BookingHistoryUpdateFormInputValues = {
    userId?: string;
    hotelName?: string;
    brand?: string;
    property?: string;
...
export declare type BookingHistoryUpdateFormValidationValues = {
...
export declare type BookingHistoryUpdateFormOverridesProps = {
    BookingHistoryUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type BookingHistoryUpdateFormProps = React.PropsWithChildren<{
    overrides?: BookingHistoryUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    bookingHistory?: any;
    onSubmit?: (fields: BookingHistoryUpdateFormInputValues) => BookingHistoryUpdateFormInputValues;
    onSuccess?: (fields: BookingHistoryUpdateFormInputValues) => void;
    onError?: (fields: BookingHistoryUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: BookingHistoryUpdateFormInputValues) => BookingHistoryUpdateFormInputValues;
    onValidate?: BookingHistoryUpdateFormValidationValues;
} & React.CSSProperties>;
export default function BookingHistoryUpdateForm(props: BookingHistoryUpdateFormProps): React.ReactElement;

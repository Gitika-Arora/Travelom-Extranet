...
export default function UsersUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setSpouse(cleanValues.spouse);
    setSpouseFirstName(cleanValues.spouseFirstName);
    setSpouseLastName(cleanValues.spouseLastName);
    ...
    setAlternatePhoneNumber(cleanValues.alternatePhoneNumber);
    setBio(cleanValues.bio);
    setFcmToken(cleanValues.fcmToken);
    setLoginType(cleanValues.loginType);
    ...
    setSubscriptionExpiryDate(cleanValues.subscriptionExpiryDate);
    setSubscriptionStatus(cleanValues.subscriptionStatus);
    setMembershipDetails(
      typeof cleanValues.membershipDetails === "string" ||
        cleanValues.membershipDetails === null
        ? cleanValues.membershipDetails
        : JSON.stringify(cleanValues.membershipDetails)
    );
    setStripeCustomerId(cleanValues.stripeCustomerId);
    setIsEmailVerified(cleanValues.isEmailVerified);

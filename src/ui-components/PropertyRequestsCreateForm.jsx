...
import { createPropertyRequests } from "../graphql/mutations";
const client = generateClient();
export default function PropertyRequestsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setFranchisePropertyCode(initialValues.franchisePropertyCode);
    setHotelName(initialValues.hotelName);
    setHotelAddress(initialValues.hotelAddress);
    setHotelCity(initialValues.hotelCity);
    setHotelState(initialValues.hotelState);
    setHotelCountry(initialValues.hotelCountry);
    setHotelZipCode(initialValues.hotelZipCode);
    setContactName(initialValues.contactName);
    setMobile(initialValues.mobile);
    setEmail(initialValues.email);
    setAdditional(initialValues.additional);
    setIsActive(initialValues.isActive);
    setIsMember(initialValues.isMember);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPropertyRequests.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PropertyRequestsCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
